...
All official documentation of workshops and other activities of UiO-Carpentry is published under the [UiO-Carpentry GitHub organisation](https://github.com/uio-carpentry). The GitHub repositories are actively maintained by the community, the Board, and the local coordinators.
Apart from repositories for workshop websites, UiO-Carpentry maintains the following community repositories:
