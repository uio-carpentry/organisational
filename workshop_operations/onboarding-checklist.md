...
- [ ] If the local coordinator has not been involved in the planning so far, please get in touch with carpadmin @ carpentry dot uio dot no about your plan for the workshop. Include information about:
...
- the Local coordinator(s) takes care of the following, so please communicate well regarding the contents in each:
  ...
  2. Creating an event page that appears under "upcoming workshops" of [UiO Library's freestanding course catalogue in English](https://www.ub.uio.no/english/courses-events/courses/other/)
...
- [ ] Involving local coordinator(s), plan well the style of the workshop;
  ...
  - **We don't recommend helping a person in trouble in the main session, either, unless the workshop size is small and you have enough time. It causes delays and frustration and reduces the engagement of the other learners. It is better to help in the exercise session while others can work on exercises. We recommend preparing both minimum and additional exercises**
...
- [ ] For backend communication, a chat platform separate from Zoom is handy. Consider by a team what is the best option to use.
- [ ] Carpentries offers now CodiMD as a collaborative online note in addition to Etherpad. Discuss in the team how to use the online notebook and who are following the online notes.
...
#### During:
  - [ ] Explain the Code of Conduct at the beginning of the workshop
  - [ ] Explain how to communicate and demonstrate how-to and/or let them try to use each function and/or platform
  - [ ] Ask the participants to answer the post-workshop survey linked from the workshop website at the end of the workshop
 ### After:
- [ ] Collect the sticky-note feedback after the workshop
- [ ] Right after the workshop, do a brief feedback round with your co-instructors and helpers
...
- [ ] Right after the workshop, do a brief feedback round with your co-instructors and helpers
- [ ] A few days after the workshop, one of the co-instructors writes up a summary of the feedback and general impressions from the workshop and sends these to the co-instructors and helpers
- [ ] One week after the workshop, the local coordinator will send out a workshop evaluation form to all participants. The coordinator provides a summary of all feedback after each term in a presentation or a written report. Ask the local coordinator for feedback for your workshop at any time.
---
